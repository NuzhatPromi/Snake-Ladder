...
public class GameBoard {
	...
	for (;;) {
		...
		e.printStackTrace();
            ...
            System.out.println("Its Player: " + currentPlayer + "'s chance to play, Role the dice by pressing enter...");
            ...
            System.out.println(player.playerName + " has rolled no " + currentPosition + " in the dice");
		...
		System.out.println(player.playerName + " has moved from the position: " + player.oldPosition
						+ " to position: " + player.currentPosition);
            }

            if (player.currentPosition >= 36) {
		System.out.println(player.playerName + " has finished the game...");
		break;
            }
    ...
    private static Integer checkIfLadderExists(Player player, int currentPosition) {
	...
	if (newLadderPosition != null) {
            ...
            System.out.println(player.playerName + " has found a ladder: " + "at position: " + currentPosition
					+ " hence moving up to a new position: " + player.currentPosition + " from position: "
					+ currentPosition);
	...
	if (newSnakePosition != null) {
            ...
            System.out.println(player.playerName + " has found a snake: " + "at position: " + currentPosition
